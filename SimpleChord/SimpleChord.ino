...
//const int notes_to_play[] = { C_4, E_4, G_4 };
//const int notes_to_play[] = { F_4, A_4, C_5 };
const int notes_to_play[] = { A_4, C_5, E_5 };
...
void setup() {
  ...
  psg.write(AY3891x::ChC_Amplitude, 0x0B); // Mid amplitude
...
/*
  ...
  */    
    ...
    */
    ...
    psg.write(AY3891x::ChA_Amplitude, 0x0B); // Lower amplitude
    psg.write(AY3891x::ChB_Amplitude, 0x00); // Mid amplitude
    psg.write(AY3891x::ChC_Amplitude, 0x00); // Mid amplitude

    for ( int j = 0 ; j < 3 ; j++ )
    {
      psg.write(AY3891x::ChA_Tone_Period_Coarse_Reg, pgm_read_word(&Notes[notes_to_play[j]]) >> 8);
      psg.write(AY3891x::ChA_Tone_Period_Fine_Reg, pgm_read_word(&Notes[notes_to_play[j]]) & TONE_GENERATOR_FINE);
      delay(delayval);
    ...
    psg.write(AY3891x::ChA_Amplitude, 0x0B); 
    psg.write(AY3891x::ChB_Amplitude, 0x0B); 
    psg.write(AY3891x::ChC_Amplitude, 0x0B);

    psg.write(AY3891x::ChA_Tone_Period_Coarse_Reg, pgm_read_word(&Notes[notes_to_play[0]]) >> 8);
    psg.write(AY3891x::ChA_Tone_Period_Fine_Reg, pgm_read_word(&Notes[notes_to_play[0]]) & TONE_GENERATOR_FINE);
    psg.write(AY3891x::ChB_Tone_Period_Coarse_Reg, pgm_read_word(&Notes[notes_to_play[1]]) >> 8);
    psg.write(AY3891x::ChB_Tone_Period_Fine_Reg, pgm_read_word(&Notes[notes_to_play[1]]) & TONE_GENERATOR_FINE);
    psg.write(AY3891x::ChC_Tone_Period_Coarse_Reg, pgm_read_word(&Notes[notes_to_play[2]]) >> 8);
    psg.write(AY3891x::ChC_Tone_Period_Fine_Reg, pgm_read_word(&Notes[notes_to_play[2]]) & TONE_GENERATOR_FINE);
